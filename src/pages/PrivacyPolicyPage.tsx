    ...
    return (
      <div className="min-h-screen bg-[#0B0C0F] pt-24 pb-12">
        <SEOHead
          ...
          description="Datenschutzrichtlinie für Autovermietung bei EasyRentCars in Graz"
          canonicalUrl="https://easyrentcars.rentals/privacy-policy"
        />
        <div className="container mx-auto px-4 sm:px-6 lg:px-12 max-w-5xl">
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="bg-[#111316] border border-[#D4AF37]/20 rounded-xl p-8 md:p-12">
          ...
          <div className="space-y-10">
            {sections.map((section, index) => {
              const headingKey = `heading_${language}` as keyof PrivacyPolicy;
              const contentKey = `content_${language}` as keyof PrivacyPolicy;
